...
//           </div>
//           {shop.tamilName && (
//             <p className="text-xs font-semibold">{shop.tamilName}</p>
//           )}
//           <p className="text-xs">{shop.name}</p>
//         </div>
...
//                     <td className="p-0.5 sm:p-1">{item.productName}</td>
//                     <td className="text-right p-0.5 sm:p-1">{item.hsnSac || '-'}</td>
//                     <td className="text-right p-0.5 sm:p-1">{item.qty || 0}</td>
//                     <td className="text-right p-0.5 sm:p-1">{(item.taxableValue || 0).toFixed(2)}</td>
//                     <td className="text-right p-0.5 sm:p-1">{(item.cgst || 0).toFixed(2)}</td>
//                     <td className="text-right p-0.5 sm:p-1">{(item.sgst || 0).toFixed(2)}</td>
//                     <td className="text-right p-0.5 sm:p-1">{(item.lineTotal || 0).toFixed(2)}</td>
//                   </tr>
//                 ))}
//                 <tr className="font-bold border-t-2 border-black">
//                   <td colSpan={3} className="p-0.5 sm:p-1">Total</td>
//                   <td className="text-right p-0.5 sm:p-1">{(invoice.subTotal || 0).toFixed(2)}</td>
//                   <td className="text-right p-0.5 sm:p-1">{(invoice.totalCGST || 0).toFixed(2)}</td>
//                   <td className="text-right p-0.5 sm:p-1">{(invoice.totalSGST || 0).toFixed(2)}</td>
//                   <td className="text-right p-0.5 sm:p-1">{(invoice.grandTotal || 0).toFixed(2)}</td>
//                 </tr>
//               </tbody>
//             </table>
//           </div>
...
export function EWayBillTemplate({ invoice, ewayDetails, accessToken }: EWayBillTemplateProps) {
